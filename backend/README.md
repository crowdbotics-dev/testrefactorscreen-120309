...
## Project Structure
    ...
    ├── testrefactorscreen_120309  # Django project configurations
...
1. Clone this repo and `cd testrefactorscreen_120309`
...
2. Clone this repo and `cd testrefactorscreen_120309`
